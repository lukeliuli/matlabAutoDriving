...
%% Scenario Authoring
R           = 760000000;      % Radius of curvature for the road      (m)
...
v0_ego = 15.6;         % Initial speed of the ego car           (m/s)
x0_ego = 4;            % Initial x position of ego car          (m)
y0_ego = 1.88;       % Initial y position of ego car          (m)
